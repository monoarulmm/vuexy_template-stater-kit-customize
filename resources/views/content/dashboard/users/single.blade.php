                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" id="multicol-roll" class="form-control"
            ...
            <div class="col-xl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <div class="mb-3">
                                <label class="form-label" for="multicol-full-name">Address</label>
                                <input type="text" id="multicol-full-name" class="form-control"
                                    placeholder="Abdullah" value="{{ $single->address }}" />
